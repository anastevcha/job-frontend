        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-4 md:mb-0">
              <h2 className="text-xl font-bold">Трудовой мост</h2>
              <p className="text-sm">© 2025 Курсовой проект. Все права защищены.</p>
            </div>
            
            <div className="flex space-x-4 mt-4 md:mt-0">
              <a href="https://telegram.com" className="hover:text-gray-400" aria-label="Telegram">
