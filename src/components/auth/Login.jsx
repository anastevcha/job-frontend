        ...
        <div>
            ...
            <div className="flex items-center justify-center max-w-7xl mx-auto">
                <form onSubmit={submitHandler} className="w-1/2 border-gray-200 rounded-md p-4 my-10">
                    ...
                    {
                        loading ? <Button className="w-full my-4"> <Loader2 className='mr-2 h-4 w-4 animate-spin' /> Пожалуйста, подождите </Button> : <Button type="submit" className="w-full my-4">Войти</Button>
                    }
